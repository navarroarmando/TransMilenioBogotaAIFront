  ...
  return (
    <div className="bg-white dark:bg-[#1a1a2e] rounded-2xl shadow-xl p-6 border border-[#015EB0]/10 dark:border-[#015EB0]/20 animate-slide-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div>
          <label className="block text-sm font-bold text-[#002E5E] dark:text-white mb-2 uppercase tracking-wide">Tamaño Población</label>
          <input
            type="number"
        ...
        <div>
          <label className="block text-sm font-bold text-[#002E5E] dark:text-white mb-2 uppercase tracking-wide">Generaciones</label>
          <input
            type="number"
        ...
        <div>
          <label className="block text-sm font-bold text-[#002E5E] dark:text-white mb-2 uppercase tracking-wide">Tasa Mutación</label>
          <input
            type="number"
            step="0.01"
        ...
        <div>
          <label className="block text-sm font-bold text-[#002E5E] dark:text-white mb-2 uppercase tracking-wide">Tasa Crossover</label>
          <input
            type="number"
            step="0.01"
        ...
        <div>
          <label className="block text-sm font-bold text-[#002E5E] dark:text-white mb-2 uppercase tracking-wide">Elitismo</label>
          <input
            type="number"
        ...
        <div className="flex items-center bg-[#F8F8F8] dark:bg-[#121212] border-2 border-[#015EB0]/20 dark:border-[#015EB0]/30 rounded-xl px-4 py-3 hover:border-[#015EB0]/40 dark:hover:border-[#015EB0]/50 transition-all duration-300">
          <label className="flex items-center gap-3 cursor-pointer">
            <input
              ...
              disabled={disabled}
              className="w-5 h-5 accent-[#015EB0] rounded focus:ring-2 focus:ring-[#015EB0] disabled:opacity-50"
            />
            <span className="text-sm font-bold text-[#002E5E] dark:text-white uppercase tracking-wide">Habilitar Dijkstra</span>
          </label>
        </div>
      </div>
    </div>
