  ...
  return (
    <div className="bg-white dark:bg-[#1a1a2e] rounded-2xl shadow-xl p-6 border border-[#926f6b] dark:border-[#015EB0]/20 animate-slide-in">
      ...
      <div 
        ...
        className="bg-[#0f172a] dark:bg-[#0a0a1a] rounded-xl p-4 h-[512px] overflow-y-auto overflow-x-hidden border-2 border-[#926f6b] dark:border-[#015EB0]/30"
      >
        {logs.length === 0 ? (
          ...
          <pre className="text-[#e31e24] dark:text-[#3EA32A] text-sm font-mono break-words whitespace-pre-wrap">
            {logs.map((log, index) => (
