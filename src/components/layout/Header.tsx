  ...
  return (
    <header className="bg-white dark:bg-[#1a1a2e] border-b border-[#3EA32A]/20 dark:border-[#015EB0]/30 px-6 py-4 flex items-center justify-between animate-fade-in transition-colors duration-300 shadow-sm">
      <div className="flex items-center gap-4">
        <h2 className="text-2xl font-bold text-[#191c1e] dark:text-gray-100">TransMind DSS</h2>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-3 p-2 rounded-lg hover:bg-[#f7f9fb] dark:hover:bg-gray-800 transition-all duration-200"
          >
            <div className="w-10 h-10 bg-gradient-to-br from-[#3EA32A] to-[#2E7A1F] dark:from-[#015EB0] dark:to-[#3EA32A] rounded-full flex items-center justify-center shadow-lg ring-2 ring-[#3EA32A]/20 dark:ring-[#3EA32A]/20">
